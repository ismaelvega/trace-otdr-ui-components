...
function EventTable({
  ...
  return /* @__PURE__ */ jsx4("div", { className: EventTable_default.wrapper, children: /* @__PURE__ */ jsxs3("table", { className: EventTable_default.table, children: [
    /* @__PURE__ */ jsx4("thead", { className: EventTable_default.head, children: /* @__PURE__ */ jsxs3("tr", { children: [
      /* @__PURE__ */ jsx4("th", { scope: "col", "aria-sort": ariaSortValue(sortState, "index"), onClick: () => setSortState((current) => cycleSortState(current, "index")), children: "#" }),
      /* @__PURE__ */ jsx4("th", { scope: "col", "aria-sort": ariaSortValue(sortState, "distance"), onClick: () => setSortState((current) => cycleSortState(current, "distance")), children: "Distance" }),
      /* @__PURE__ */ jsx4("th", { scope: "col", "aria-sort": ariaSortValue(sortState, "type"), onClick: () => setSortState((current) => cycleSortState(current, "type")), children: "Type" }),
      /* @__PURE__ */ jsx4("th", { scope: "col", "aria-sort": ariaSortValue(sortState, "spliceLoss"), onClick: () => setSortState((current) => cycleSortState(current, "spliceLoss")), children: "Splice Loss" }),
      /* @__PURE__ */ jsx4("th", { scope: "col", "aria-sort": ariaSortValue(sortState, "reflLoss"), onClick: () => setSortState((current) => cycleSortState(current, "reflLoss")), children: "Refl. Loss" }),
      !compact ? /* @__PURE__ */ jsxs3(Fragment, { children: [
        /* @__PURE__ */ jsx4("th", { scope: "col", "aria-sort": ariaSortValue(sortState, "slope"), onClick: () => setSortState((current) => cycleSortState(current, "slope")), children: "Slope" }),
        /* @__PURE__ */ jsx4("th", { scope: "col", children: "Status" })
      ] }) : null
    ] }) }),
    /* @__PURE__ */ jsx4("tbody", { className: EventTable_default.body, children: rows.map((row) => /* @__PURE__ */ jsxs3(
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ jsx4("td", { children: row.index + 1 }),
          /* @__PURE__ */ jsx4("td", { children: formatDistance(row.distance, xUnit) }),
          ...
          !compact ? /* @__PURE__ */ jsxs3(Fragment, { children: [
            ...
            /* @__PURE__ */ jsx4("td", { children: /* @__PURE__ */ jsx4(StatusBadge, { status: row.status }) })
          ] }) : null
        ]
      },
    ...
    /* @__PURE__ */ jsx4("tfoot", { className: EventTable_default.footer, children: /* @__PURE__ */ jsxs3("tr", { children: [
      ...
      /* @__PURE__ */ jsxs3("td", { colSpan: compact ? 2 : 1, children: [
        "Total Loss: ",
        summary.totalLoss.toFixed(3),
        " dB"
      ] }),
      !compact ? /* @__PURE__ */ jsxs3("td", { children: [
        "ORL: ",
...
function LossBudgetChart({
  ...
  return /* @__PURE__ */ jsx5("section", { className: `${LossBudgetChart_default.root} ${vertical ? LossBudgetChart_default.vertical : ""}`, "aria-label": "Loss budget chart", children: /* @__PURE__ */ jsx5("div", { className: LossBudgetChart_default.chart, children: rows.rows.map((row) => /* @__PURE__ */ jsxs4(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs4("span", { className: `${LossBudgetChart_default.track} ${vertical ? LossBudgetChart_default.trackVertical : ""}`, children: [
          warnPct !== null ? /* @__PURE__ */ jsx5("span", { className: `${LossBudgetChart_default.threshold} ${vertical ? LossBudgetChart_default.thresholdVertical : ""}`, style: vertical ? { bottom: `${warnPct}%` } : { left: `${warnPct}%` } }) : null,
          failPct !== null ? /* @__PURE__ */ jsx5("span", { className: `${LossBudgetChart_default.threshold} ${vertical ? LossBudgetChart_default.thresholdVertical : ""}`, style: vertical ? { bottom: `${failPct}%` } : { left: `${failPct}%` } }) : null,
          /* @__PURE__ */ jsx5(
            "span",
            {
...
import { useMemo as useMemo5, useRef as useRef3 } from "react";
...
function FiberMap({
  ...
  return /* @__PURE__ */ jsx6("section", { className: FiberMap_default.root, "aria-label": "Fiber map", children: /* @__PURE__ */ jsxs5("svg", { viewBox: isVertical ? "0 0 180 420" : "0 0 1000 180", className: FiberMap_default.svg, children: [
    isVertical ? /* @__PURE__ */ jsxs5(Fragment2, { children: [
      /* @__PURE__ */ jsx6("line", { x1: "90", y1: "24", x2: "90", y2: "390", stroke: "#334155", strokeWidth: "2" }),
      ...
      /* @__PURE__ */ jsx6("line", { x1: "30", y1: "90", x2: "970", y2: "90", stroke: "#334155", strokeWidth: "2" }),
      ...
      return /* @__PURE__ */ jsxs5(
        "g",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs5("text", { x: isVertical ? x + 14 : x, y: isVertical ? y + 4 : y - 14, textAnchor: isVertical ? "start" : "middle", className: FiberMap_default.label, children: [
              "#",
              item.index + 1
            ] })
          ]
...
function SorDropZone({ multiple = false, parseOptions, children, onResult, onError }) {
  ...
  const [dragHover, setDragHover] = useState3(false);
...
import { createContext, useContext, useMemo as useMemo6, useState as useState4 } from "react";
import { jsx as jsx8 } from "react/jsx-runtime";
var EventSelectionContext = createContext(null);
function EventSelectionProvider({ children }) {
  const [selectedIndex, setSelectedIndex] = useState4(null);
...
function PrintButton({ label = "Print" }) {
  return /* @__PURE__ */ jsx9("button", { type: "button", onClick: () => window.print(), children: label });
}
...
function useCompactLayout(layout, hostRef) {
  const [compact, setCompact] = useState5(layout === "compact");
  useEffect3(() => {
    if (layout === "compact") {
      setCompact(true);
      return;
...
//# sourceMappingURL=chunk-D5W6UXM6.js.map