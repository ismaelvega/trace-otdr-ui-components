...
function EventTable({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: EventTable_default.wrapper, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("table", { className: EventTable_default.table, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("thead", { className: EventTable_default.head, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tr", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { scope: "col", className: `${EventTable_default.numeric} ${EventTable_default.indexCol}`, "aria-sort": ariaSortValue(sortState, "index"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: EventTable_default.sortButton, onClick: () => setSortState((current) => cycleSortState(current, "index")), children: "#" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { scope: "col", className: `${EventTable_default.numeric} ${EventTable_default.distanceCol}`, "aria-sort": ariaSortValue(sortState, "distance"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: EventTable_default.sortButton, onClick: () => setSortState((current) => cycleSortState(current, "distance")), children: "Distance" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { scope: "col", "aria-sort": ariaSortValue(sortState, "type"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: EventTable_default.sortButton, onClick: () => setSortState((current) => cycleSortState(current, "type")), children: "Type" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { scope: "col", className: EventTable_default.numeric, "aria-sort": ariaSortValue(sortState, "spliceLoss"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: EventTable_default.sortButton, onClick: () => setSortState((current) => cycleSortState(current, "spliceLoss")), children: "Splice Loss" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { scope: "col", className: EventTable_default.numeric, "aria-sort": ariaSortValue(sortState, "reflLoss"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: EventTable_default.sortButton, onClick: () => setSortState((current) => cycleSortState(current, "reflLoss")), children: "Refl. Loss" }) }),
      !compact ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { scope: "col", className: EventTable_default.numeric, "aria-sort": ariaSortValue(sortState, "slope"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: EventTable_default.sortButton, onClick: () => setSortState((current) => cycleSortState(current, "slope")), children: "Slope" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { scope: "col", className: EventTable_default.statusCol, children: "Status" })
      ] }) : null
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tbody", { className: EventTable_default.body, children: rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { className: `${EventTable_default.numeric} ${EventTable_default.indexCol}`, children: row.index + 1 }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { className: `${EventTable_default.numeric} ${EventTable_default.distanceCol}`, children: formatDistance(row.distance, xUnit) }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("td", { className: EventTable_default.numeric, children: [
          ...
          !compact ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { className: EventTable_default.statusCol, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatusBadge, { status: row.status }) })
          ] }) : null
        ]
      },
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tfoot", { className: EventTable_default.footer, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tr", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("td", { className: EventTable_default.numeric, colSpan: compact ? 2 : 1, children: [
        "Total Loss: ",
        summary.totalLoss.toFixed(3),
        " dB"
      ] }),
      !compact ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("td", { className: EventTable_default.numeric, children: [
        "ORL: ",
...
function LossBudgetChart({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: `${LossBudgetChart_default.root} ${vertical ? LossBudgetChart_default.vertical : ""}`, "aria-label": "Loss budget chart", children: [
    rows.dominantScaleActive ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: LossBudgetChart_default.scaleHint, children: "Scaled for readability. Bars with an overflow marker exceed display scale." }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: LossBudgetChart_default.chart, children: rows.rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: `${LossBudgetChart_default.track} ${vertical ? LossBudgetChart_default.trackVertical : ""}`, children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${LossBudgetChart_default.zero} ${vertical ? LossBudgetChart_default.zeroVertical : ""}` }),
            warnPct !== null ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${LossBudgetChart_default.threshold} ${LossBudgetChart_default.warnThreshold} ${vertical ? LossBudgetChart_default.thresholdVertical : ""}`, style: vertical ? { bottom: `${warnPct}%` } : { left: `${warnPct}%` } }) : null,
            failPct !== null ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${LossBudgetChart_default.threshold} ${LossBudgetChart_default.failThreshold} ${vertical ? LossBudgetChart_default.thresholdVertical : ""}`, style: vertical ? { bottom: `${failPct}%` } : { left: `${failPct}%` } }) : null,
            ...
            row.overflow ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${LossBudgetChart_default.overflowCue} ${vertical ? LossBudgetChart_default.overflowCueVertical : ""}` }) : null
          ] }),
...
function FiberMap({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("section", { className: `${FiberMap_default.root} ${isVertical ? FiberMap_default.vertical : ""}`, "aria-label": "Fiber map", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("svg", { viewBox: isVertical ? "0 0 180 420" : "0 0 1000 180", className: FiberMap_default.svg, children: [
    isVertical ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("line", { x1: "90", y1: "24", x2: "90", y2: "390", className: FiberMap_default.path }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("line", { x1: "30", y1: "90", x2: "970", y2: "90", className: FiberMap_default.path }),
    ...
    prepared.map((item) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
        "g",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("circle", { cx: x, cy: y, r: "7.5", className: markerClass }),
            item.labelVisible ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("line", { x1: x, y1: y, x2: connectorX, y2: connectorY, className: FiberMap_default.labelConnector }) : null,
            item.labelVisible ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("text", { x: labelX, y: labelY, textAnchor: labelAnchor, className: `${FiberMap_default.label} ${FiberMap_default.eventLabel}`, children: [
              "#",
              item.index + 1
            ] }) : null,
            item.clusterCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("g", { className: FiberMap_default.cluster, children: [
...
function PrintButton({ label = "Print" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: PrintButton_default.button, onClick: () => window.print(), children: label });
}
...
function TraceComparison({ traces, mode = "overlay", syncZoom = true }) {
  ...
  if (mode === "side-by-side") {
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("section", { className: TraceComparison_default.root, children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: TraceComparison_default.sideBySide, children: normalized.map((item) => /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("article", { className: TraceComparison_default.panel, children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("h3", { className: TraceComparison_default.title, children: item.label }),
  ...
  if (mode === "difference") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("section", { className: TraceComparison_default.root, children: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("article", { className: TraceComparison_default.panel, children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("h3", { className: TraceComparison_default.title, children: "Difference (Trace 1 - Trace 2)" }),
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(TraceChart, { trace: difference, events: [] })
    ] }) });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("section", { className: TraceComparison_default.root, children: [
    ...
    primary ? /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("article", { className: TraceComparison_default.panel, children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("h3", { className: TraceComparison_default.title, children: "Overlay" }),
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(TraceChart, { trace: primary.data.trace, events: primary.data.keyEvents.events, overlays })
    ] }) : null
  ] });
}
